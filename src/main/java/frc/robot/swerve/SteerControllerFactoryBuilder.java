...
public final class SteerControllerFactoryBuilder {
    ...
    public frc.robot.swerve.SteerControllerFactoryBuilder withPidConstants(double proportional, double integral, double derivative) {
    ...
    public frc.robot.swerve.SteerControllerFactoryBuilder withVoltageCompensation(double nominalVoltage) {
    ...
    public frc.robot.swerve.SteerControllerFactoryBuilder withCurrentLimit(double currentLimit) {
    ...
    public <T> SteerControllerFactory<frc.robot.swerve.SteerControllerFactoryBuilder.ControllerImplementation, NeoSteerConfiguration<T>> build(AbsoluteEncoderFactory<T> encoderFactory) {
        return new frc.robot.swerve.SteerControllerFactoryBuilder.FactoryImplementation<>(encoderFactory);
    }

    public class FactoryImplementation<T> implements SteerControllerFactory<frc.robot.swerve.SteerControllerFactoryBuilder.ControllerImplementation, NeoSteerConfiguration<T>> {
        ...
        @Override
        public void addDashboardEntries(ShuffleboardContainer container, frc.robot.swerve.SteerControllerFactoryBuilder.ControllerImplementation controller) {
        ...
        @Override
        public frc.robot.swerve.SteerControllerFactoryBuilder.ControllerImplementation create(NeoSteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
